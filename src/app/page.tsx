            ...
            <div className="lg:grid lg:grid-cols-2 lg:gap-12 items-center">
              ...
              <div className="mt-10 lg:mt-0">
                <div className="rounded-lg overflow-hidden shadow-2xl transform hover:scale-105 transition-transform duration-300">
                  <Image
                    src="https://images.unsplash.com/photo-1565792508300-28f7e5e3f764?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80"
                    alt="تدريب العمال"
                    width={800}
                    height={450}
